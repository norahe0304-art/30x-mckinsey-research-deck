 ...
 * [POS]: 包的唯一入口 — npx 30x-mckinsey-deck 即安装，无任何依赖
...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`
30x-mckinsey-deck — McKinsey-grade market research decks for Claude Code

用法:
  npx 30x-mckinsey-deck            安装到 ~/.claude/skills/   (全局, 推荐)
  npx 30x-mckinsey-deck --project  安装到 ./.claude/skills/   (仅当前项目)
